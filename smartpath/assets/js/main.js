...
fetch("header.html")
  ...
  .then((data) => {
    ...
    // Copy menu content to mobile menu container
    if ($(".it-menu-content").length && $(".it-menu-mobile").length) {
      let navContent = document.querySelector(".it-menu-content").outerHTML;
      let mobileNavContainer = document.querySelector(".it-menu-mobile");
      mobileNavContainer.innerHTML = navContent;
      ...
      arrow.each(function () {
        ...
        self.find(".dropdown-toggle-btn").on("click", function (e) {
          ...
          let self = $(this);
          self.toggleClass("dropdown-opened");
          self.parent().parent().toggleClass("expanded");
          self
            .parent()
            .parent()
            .children(".it-submenu")
...
fetch("footer.html")
  ...
  .then((data) => {
    ...
    // Initialize popup functionality after footer is loaded
    initHelpFormPopup();
  });

// Help Form Popup Functionality
function initHelpFormPopup() {
  const openBtn = document.getElementById("openHelpForm");
  const closeBtn = document.getElementById("closeHelpForm");
  const overlay = document.getElementById("helpFormOverlay");
  const form = document.getElementById("admissionForm");

  // Check if already initialized
  if (openBtn && openBtn.dataset.initialized === "true") {
    return;
  }
