...
@section('title', 'All Webinar Registrations')
@section('page-title', 'All Webinar Registrations')
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Webinar Registrations</h3>
                    ...
                    <tbody>
                        @forelse($registrations as $registration)
                            <tr>
                                ...
                                <td>
                                    <strong>{{ Str::limit($registration->webinar->title, 40) }}</strong>
                                </td>
